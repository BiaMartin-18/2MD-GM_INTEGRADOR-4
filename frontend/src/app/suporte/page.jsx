      ...
      <main className="suporte-wrapper-content">
            ...
            <div className="row">
              <div className="col-lg-12">
                <h1 className="hero-title-axionet mb-3">
                  ...
                  <br />
                  <span className="text-accent-axionet">Nossa Equipe de Suporte</span>
                </h1>
                <p className="hero-lead-axionet">
                  Estamos aqui para ajudar você a maximizar a eficiência do Controle PDI. Descreva o problema ou
                  necessidade para que nosso especialista no gerenciamento de defeitos e custos possa auxiliar rapidamente.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-5">
          <div className="container">
            ...
            <h2 className="section-title-specialist-axionet mb-5">
              Conecte-se <span className="text-accent-axionet">com um Especialista</span>
            </h2>
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row g-3">
                      ...
                      <div className="col-md-6">
                        <label htmlFor="firstName" className="form-label small text-muted">Primeiro Nome*</label>
                        <input type="text" className="form-control" id="firstName" placeholder="Seu Primeiro Nome" required />
                      </div>
                      <div className="col-md-6">
                        <label htmlFor="lastName" className="form-label small text-muted">Sobrenome*</label>
                        <input type="text" className="form-control" id="lastName" placeholder="Seu Sobrenome" required />
                      </div>

                      {/* Segunda Linha: E-mail e Telefone */}
                      <div className="col-md-6">
                        <label htmlFor="emailAddress" className="form-label small text-muted">E-mail Corporativo*</label>
                        <input type="email" className="form-control" id="emailAddress" placeholder="email@gm.com" required />
                      </div>
                      <div className="col-md-6">
                        <label htmlFor="phone" className="form-label small text-muted">Telefone</label>
                        <input type="tel" className="form-control" id="phone" placeholder="(XX) XXXX-XXXX" />
                      </div>

                      {/* Terceira Linha: Área/Setor e Cargo */}
                      <div className="col-md-6">
                        <label htmlFor="companyName" className="form-label small text-muted">Nome da Área/Setor*</label>
                        <input type="text" className="form-control" id="companyName" placeholder="Ex: Engenharia de Qualidade" required />
                      </div>
                      <div className="col-md-6">
                        <label htmlFor="jobTitle" className="form-label small text-muted">Cargo</label>
                        <input type="text" className="form-control" id="jobTitle" placeholder="Ex: Supervisor de Manutenção" />
                      </div>

                      {/* Quarta Linha: Modelo de Veículo e Tipo de Solicitação (Selects) */}
                      <div className="col-md-6">
                        <label htmlFor="vehicleModel" className="form-label small text-muted">Modelo de Veículo</label>
                      ...
                      <div className="col-md-6">
                        <label htmlFor="issueType" className="form-label small text-muted">Tipo de Solicitação*</label>
                      ...
                      <div className="col-12">
                        <label htmlFor="message" className="form-label small text-muted">Mensagem</label>
                        <textarea className="form-control" id="message" rows="4" placeholder="Descreva seu problema com detalhes, mencionando placas ou códigos de erro, se houver." required></textarea>
                      </div>
                      ...
                      <div className="col-12 mt-3">
                        <div className="form-check">
                          ...
                          <label className="form-check-label small text-muted" htmlFor="privacyCheck">
                            Ao enviar, concordo com o processamento dos dados conforme a
                            <a href="#" className="text-decoration-none text-accent-axionet"> Política de Privacidade</a>
                          </label>
                        </div>
                      </div>
                      <div className="col-12 mt-4">
                        <button type="submit" className="btn btn-lg w-100 btn-submit-axionet">
                          Enviar Solicitação
                        </button>
                      </div>
                    </div>
